...
img_path = "/home/dmp/Videos/val/real"
video_paths = glob.glob(img_path + "/*")
# videos = ["/home/dmp/Videos/train/real/2020-09-10-164549.webm", "/home/dmp/Videos/train/real/2020-09-10-164156.webm", "/home/dmp/Videos/train/real/2020-09-10-164802.webm"]
videos = []
for video_path in video_paths:
    ...
    while cap.isOpened():
        ...
        try:
            ...
            cv2.imwrite(live_path + "/" + face_name, face)
